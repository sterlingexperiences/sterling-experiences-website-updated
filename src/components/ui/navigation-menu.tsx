...
function NavGridCard({ link, ...props }: React.ComponentProps<"div"> & { link: NavItemType }) {
  return (
...
function NavSmallItem({
  ...
  className,
  ...props
}: React.ComponentProps<typeof NavigationMenuLink> & { item: Omit<NavItemType, "description"> }) {
  return (
...
function NavLargeItem({ link, className, ...props }: React.ComponentProps<typeof NavigationMenuLink> & { link: NavItemType }) {
  return (
    <NavigationMenuLink className={cn("bg-background group relative flex flex-col justify-center border p-0", className)} {...props}>
...
function NavItemMobile({ item, className, ...props }: React.ComponentProps<"a"> & { item: NavItemType }) {
  return (
    <a
      className={cn(
      ...
      {...props}
    >
      <div className="bg-muted/20 flex size-10 items-center justify-center rounded-lg border">
        {item.icon && <item.icon />}
      </div>
...
export {
  ...
  NavigationMenuViewport, NavGridCard, NavSmallItem, NavLargeItem, NavItemMobile,
  type NavItemType,
};
