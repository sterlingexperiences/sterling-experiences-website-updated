...
const Info = () => {
  ...
  const contactChannels = [
    ...
    },
    {
      icon: Mail,
      label: "Email",
      value: "sterlingxperiences@gmail.com",
      href: "mailto:sterlingxperiences@gmail.com",
    },
  ];
    ...
    <div ref={sectionRef}>
      ...
      <div className={cn(
        ...
        <p className="font-openSans text-[15px] md:text-[17px] text-neutral-600 leading-[1.7] max-w-[650px] mx-auto">
          We do not offer fixed packages because no two events are the same. Tell us
          what you are building and we will design an approach that fits your scope,
          your guests, and your vision.
        </p>
        <CalButton
      ...
      <div className="flex items-center justify-center gap-4 mb-12">
        ...
        <span className="font-ebGaramond text-[20px] md:text-[28px] text-brand-gold font-[500]">Get in touch</span>
        <div className="w-full max-w-[120px] md:max-w-[180px] h-[2px] overflow-hidden">
          <div
            className={cn(
              "h-full transition-all duration-800 ease-[cubic-bezier(0.4,0,0.2,1)] shadow-[0_0_6px_rgba(255,215,0,0.6)]",
          ...
          <div className="md:px-8">
            ...
            <div className={cn(
              ...
              {contactChannels.map((channel, i) => (
                ...
                >
                  ...
                  <div className="min-w-0">
                    <p className="font-openSans text-[13px] text-neutral-500 font-medium">{channel.label}</p>
                    <p className="font-openSans text-[14px] md:text-[15px] text-neutral-800 font-semibold truncate">{channel.value}</p>
                  </div>
                </a>
              ))}
              ...
              >
                ...
                <div className="min-w-0">
                  <p className="font-openSans text-[13px] text-neutral-500 font-medium">Instagram</p>
                  <p className="font-openSans text-[14px] md:text-[15px] text-neutral-800 font-semibold truncate">@sterling_experiences</p>
                </div>
              </a>
              ...
              >
                ...
                <div className="min-w-0">
                  <p className="font-openSans text-[13px] text-neutral-500 font-medium">LinkedIn</p>
                  <p className="font-openSans text-[14px] md:text-[15px] text-neutral-800 font-semibold truncate">@sterling_xperiences</p>
                </div>
              </a>
              ...
              <div className="flex items-center gap-4 p-4 md:p-5 rounded-[12px] border border-neutral-200/80 hover:border-brand-purple/40 hover:shadow-[0_4px_16px_rgba(128,0,128,0.08)] bg-white transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] group">
                ...
                <div className="min-w-0 flex-1">
                  <p className="font-openSans text-[13px] text-neutral-500 font-medium">Book a call</p>
                  <CalButton title="Book a 30-minute call" variant="link" className="h-auto p-0 text-[14px] md:text-[15px] font-semibold text-brand-purple hover:text-brand-purple/80" />
                </div>
              </div>
            </div>
            ...
            <div className={cn(
              ...
              <ul className="space-y-3">
                {enquiryItems.map((item, i) => (
                  <li key={i} className="flex items-start gap-3 font-openSans text-[14px] md:text-[16px] text-neutral-700 leading-[1.6]">
            ...
            <div className={cn(
              ...
              <p className="font-ebGaramond italic text-[22px] md:text-[28px] text-neutral-700 leading-[1.4] max-w-[600px] mx-auto">
                &ldquo;We do not believe in one-size-fits-all solutions. We believe in yours.&rdquo;
              </p>
            </div>
          </div>
        </div>
