...
const Header = () => {
  ...
  return (
    <section className="relative w-full min-h-[45vh] md:min-h-[55vh] flex flex-col justify-center items-center overflow-hidden" style={{ background: "url(/assets/images/contact.png) no-repeat center center/cover" }}>
      {/* Dark overlay */}
