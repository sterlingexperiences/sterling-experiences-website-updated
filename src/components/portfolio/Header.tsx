...
const Header = () => {
  ...
  return (
    <section className="relative w-full min-h-[45vh] md:min-h-[55vh] flex flex-col justify-center items-center portfolio_bg overflow-hidden">
      {/* Dark overlay */}
      ...
      >
        <nav className="flex items-center gap-2 text-[15px] font-body">
          ...
          <span className="text-secondary font-semibold">Portfolio</span>
        </nav>
      </div>
    </section>
  );
